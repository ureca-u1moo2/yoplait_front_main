...
function FAQPage() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: '네! 비회원도 간단한 질의응답을 통해 맞춤 요금제를 추천받을 수 있습니다. 다만, 더 정확하고 개인화된 추천을 원하시면 회원가입을 해주세요!'
    },
    {
      id: 3,
    ...
    },
    {
      ...
      answer: '마이페이지에서 해지하고 싶은 요금제의 "해지하기" 버튼을 클릭하시면 됩니다. 해지 시 위약금이 발생할 수 있으니 약관을 확인해주세요.'
    },
    {
      id: 5,
      category: 'billing',
